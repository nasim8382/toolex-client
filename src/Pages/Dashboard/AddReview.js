          ...
          <div className="card-body text-primary">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form-control w-full max-w-xs mb-7">
                <input placeholder="Your Name" className="input input-bordered w-full max-w-xs text-xl" type="text" {...register("name", { value: user?.displayName})} readOnly disabled/>
              </div>

              <div className="form-control w-full max-w-xs mb-8">
                <input placeholder="Your Email" className="input input-bordered w-full max-w-xs text-xl" type="text" {...register("email", { value: user?.email})} readOnly disabled/>
              </div>
